...
// import { AppShell } from '@/components/common/loader/app-shell';
...
//         {/*
//           AppShell shows the DocNear splash loader on first visit (~2.6s),
//           then fades out smoothly. After that, loading.tsx handles
//           route-level loading for navigations within the app.
//         */}
